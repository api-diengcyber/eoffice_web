        ...
        top: 0px;
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="<?php echo base_url('pegawai/tugas/detail/'.$this->uri->segment(4));?>" class="btn btn-primary btn-xs pull-right"><i class="fa fa-eye"></i> Lihat Detail</a>
                    </div>
                </div>
            </div><!-- /.page-header -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-body">
                                <form action="<?php echo base_url() ?>pegawai/tugas/create_action" method="post" enctype="multipart/form-data">
...
<script>
  $(document).ready(function(){
        $('#btnMessage').click(function(){
              ...
              $.ajax({
                url :'<?php echo base_url();?>pegawai/tugas/reply_message',
                type:'post',
  ...
  {
    $.ajax({
      url:'<?php echo base_url();?>pegawai/tugas/read_message',
      type:'post',
      data:{id:id},
      success:function(response){
        console.log('sukses');
