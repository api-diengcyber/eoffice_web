            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <?php } ?> -->
                        <button class="btn btn-primary" style="position:absolute;top:10px;right:10px" data-toggle="modal" data-target="#modalSusulan"><i class="mdi mdi-clipboard-check"></i> Input Tugas hari ini</button>
                        <!-- Modal -->
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">  
                                  ...
                                  <li class="nav-item">
                                    <a class="nav-link " id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Tugas Baru</a>
                                  </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                  <div class="tab-pane fade card card-body" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <form action="<?php echo base_url('training/tugas/susulan') ?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="tugas" id="" cols="30" rows="10" class="form-control" placeholder="Deskripsi tugas anda"></textarea>
                                            </div>
                                            <div class="form-group">
                                  ...
                                  <div class="tab-pane fade show active card card-body border" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <form action="<?php echo base_url('training/tugas/create_action') ?>" method="post">
                                            <div class="form-group mb-2" >
                                                <label for="">Pilih tugas</label>
                                                <select name="id_tugas" id="id_tugas" class="form-control mb-2">
                                                    <?php foreach ($tugas_belum_selesai as $key): ?>
                                                    <option value="<?php echo $key->id ?>"><?php echo $key->judul ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                                <button class="btn btn-primary" type="button" onclick="upload()">Upload tugas</button>
                                                <script>
                                                    var id = 0;
                                                    $(document).ready(function(){
                                                        id = $('#id_tugas').val();
                                                        $('#id_tugas').change(function(){
                                                            id = $('#id_tugas').val();
                                                        });
                                                    });
                                                    function upload(){
                                                        //alert(id);
                                                        window.location = '<?php echo base_url();?>training/tugas/read/'+id;
                                                    }
                                                </script>
                                            </div>
                                        </form>
                                            ...
                                            <ol class="dd-list unstyled" style="padding-left:0px">
                                                ...
                                                <li class="dd-item card p-2 mb-2 border-bottom dd2-item item-<?php echo $warna_item;?>">
                                                    <div class="dd2-content">
                                                        ...
                                                        <!--<a class="btn <?php echo $btn ?> btn-xs" href="<?php echo base_url() ?>marketing/tugas/read/<?php echo $key->id ?>"> Buka Tugas</a>-->
                                                    </div>
                                                </li>
                                                <?php endforeach;
                                                }else{
                                        ...
                                        <ol class="dd-list unstyled" style="padding-left:0px">
                                            ...
                                            <li class="dd-item card card-body mb-2 dd2-item item-<?php echo $warna_item;?>">
                                                <div class="dd2-content">
                                                    ...
                                                    <a class="btn <?php echo $btn ?> btn-xs" href="<?php echo base_url() ?>training/tugas/read/<?php echo $key->id ?>"> Buka Tugas</a>
                                                </div>
                                            </li>
                                            <hr>
                                            <?php endforeach ?>
