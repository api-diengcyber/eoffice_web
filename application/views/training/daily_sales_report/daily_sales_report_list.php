              ...
              <div class="col-12 card card-body">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <div class="row" style="margin-bottom: 10px">
                        <div class="col-lg-2">
                            <?php echo anchor(site_url('training/daily_sales_report/create'), 'Tambah Baru', 'class="btn btn-primary"'); ?>
                        </div> 
                        <div class="col-lg-5">
                        ...
                        $(document).ready(function() {
                            ...
                            var t = $("#mytable").dataTable({
                                ...
                                rowCallback: function(row, data, iDisplayIndex) {
                                    ...
                                    var btn_status = "";
                                        btn_status = '&nbsp;<a href="<?php echo base_url() ?>training/daily_sales_report/follow_up/'+data.id+'" class="btn btn-danger btn-minier">FOLLOW UP</a>';
