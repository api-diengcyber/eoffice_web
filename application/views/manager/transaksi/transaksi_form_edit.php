                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <input type="text" class="form-control" name="dp" id="dp" placeholder="DP" value="<?php echo number_format($dp,0,',','.'); ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <input type="text" class="form-control" name="barang" id="barang" placeholder="Barang" value="" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
jQuery(function($){
    ...
    var t = $("#mytable").dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?php echo base_url() ?>admin/transaksi/json_barang_edit/<?php echo $id ?>", "type": "POST"},
        columns: [
            {
                "data": "id",
                "orderable": false
    ...
    $("#mytable").on('draw.dt', function(){
        $("button[id*=btn_hapus_temp]").click(function(){
            ...
            if (c) {
                $.ajax({
                    url: '<?php echo base_url() ?>admin/transaksi/hapus_barang_edit',
                    type: 'post',
                    data: 'id='+data_id,
                }).done(function(data){
                    t_api.draw(); 
        ...
        $("input[id*=jumlah], input[id*=diskon]").change(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url() ?>admin/transaksi/update_barang_edit',
                type: 'post',
    ...
    $("#btn_simpan_barang").click(function(){
        ...
        $.ajax({
            url: '<?php echo base_url() ?>admin/transaksi/simpan_barang_edit',
            type: 'post',
            data: 'id=<?php echo $id ?>&barang='+barang+'&harga='+harga,
        }).done(function(data){
            t_api.draw();
            $("#barang").val(''); 
            $("#harga").val(''); 
