                                ...
                                columns: [
                                    ...
                                    {"data": "gaji_pokok",
                                        render:function(data,type,row){
                                            var id = data;
                                            var total = 0;
                                            if(data_gajian.id_pegawai[id] != null){
                                                var total = data_gajian.id_pegawai[id].gaji_kotor;
                                            }
                                    ...
                                    {"data": "id_pegawai",
                                        render:function(data){
                                            ...
                                            var hari_masuk = 0;
                                            if(data_gajian.id_pegawai[id] != null){
                                                hari_masuk = data_gajian.id_pegawai[id].masuk;
                                            }
                                    ...
                                    */
                                    {"data": "id_pegawai",//potongan absen
                                        render:function(data){
                                            ...
                                            var total = 0;
                                            if(data_gajian.id_pegawai[id] != null){
                                                var total = data_gajian.id_pegawai[id].potongan_absen;
                                            }                                       
                                    ...
                                    {"data": "id_pegawai",//gaji bersih
                                        render:function(data,type,row,meta){
                                            ...
                                            var total = 0;
                                            if(data_gajian.id_pegawai[id] != null){
                                                var total = data_gajian.id_pegawai[id].gaji_bersih;
                                            }                                        
                                            return Math.round(total / 1000) * 1000;
                                        },"orderable": false
                                    },
