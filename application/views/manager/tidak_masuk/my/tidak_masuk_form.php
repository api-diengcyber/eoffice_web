                ...
                <div class="col-12 card card-body">
                    ...
                    <form action="<?php echo $action; ?>" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="datepicker form-control" name="tgl" placeholder="Tgl" value="<?php echo $tgl; ?>" />
                        </div>
                        <div class="form-group">
                        ...
                        <a href="<?php echo site_url('manager/tidak_masuk/my_index') ?>" class="btn btn-danger">Cancel</a>
                    </form>
                    <!-- PAGE CONTENT ENDS -->
                </div><!-- /.col -->
            </div><!-- /.row -->
