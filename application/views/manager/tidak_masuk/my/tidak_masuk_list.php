                ...
                <div class="col-12">
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-md-4 text-right">
                            <?php echo anchor(site_url('manager/tidak_masuk/my_create'), 'Create', 'class="btn btn-primary"'); ?>
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 10px">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var t = $("#mytable").dataTable({
                                ...
                                processing: true,
                                serverSide: true,
                                ajax: {"url": "<?php echo base_url() ?>manager/tidak_masuk/json/<?php echo $bulan ?>/<?php echo $tahun ?>", "type": "POST"},
                                columns: [
                                    {
                                        "data": "id",
                                        "orderable": false
                                    },{"data": "tgl"},{"data": "ket_tidak_masuk"},{"data": "keterangan"},
                                    {
                                        ...
                                        render:function(data){
                                            return '<a href="<?php echo base_url()?>manager/tidak_masuk/update/'+data+'" class="btn btn-primary btn-xs">Edit</a>';
                                        }
                                    }
                                ],
                                order: [[0, 'desc']],
