                ...
                <div class="col-12">
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <!--<div class="col-md-4 text-right">
                            <?php echo anchor(site_url('manager/tidak_masuk/create'), 'Create', 'class="btn btn-primary"'); ?>
                        </div>-->
                    </div>
                    <div class="row" style="margin-bottom: 10px">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var t = $("#mytable").dataTable({
                                ...
                                processing: true,
                                serverSide: true,
                                ajax: {"url": "<?php echo base_url() ?>manager/tidak_masuk/json/<?php echo $id_users ?>/<?php echo $bulan ?>/<?php echo $tahun ?>", "type": "POST"},
                                columns: [
                                    {
                                        "data": "id",
                                        "orderable": false
                                    },{"data": "tgl"},{"data": "nama_pegawai"},{"data": "ket_tidak_masuk"},
                                    {
                                        "data" : "action",
                                        "orderable": false,
