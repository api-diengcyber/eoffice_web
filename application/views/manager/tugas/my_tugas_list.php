                              ...
                              <div class="modal-body">
                                ...
                                <div class="tab-content" id="myTabContent">
                                  <div class="tab-pane fade card card-body" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <form action="<?php echo base_url('manager/tugas/my_susulan') ?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                  ...
                                  <div class="tab-pane fade show active card card-body border" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <form action="<?php echo base_url('manager/tugas/my_create_action') ?>" method="post">
                                            <div class="form-group mb-2" >
                                                ...
                                                <script>
                                                    ...
                                                    function upload(){
                                                        //alert(id);
                                                        window.location = '<?php echo base_url();?>manager/tugas/my_read/'+id;
                                                    }
                                                </script>
                                            </div>
                                        </form>
                                            ...
                                            <ol class="dd-list unstyled" style="padding-left:0px">
                                                ...
                                                <li class="dd-item card p-2 mb-2 border-bottom dd2-item item-<?php echo $warna_item;?>">
                                                    <div class="dd2-content">
                                                        ...
                                                        <!--<a class="btn <?php echo $btn ?> btn-xs" href="<?php echo base_url() ?>manager/tugas/my_read/<?php echo $key->id ?>"> Buka Tugas</a>-->
                                                    </div>
                                                </li>
                                                <?php endforeach;
                                                }else{
                                                        ...
                                                        <div class="modal fade" id="md<?php echo $key->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                          <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                              ...
                                                              <div class="modal-body">
                                                                <img src="<?php echo base_url('assets/tugas/my_upload/').$key->file ?>" alt="" class="mt-2 mb-2" style="width:100%">
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>
