        ...
        top: 0px;
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="<?php echo base_url('manager/tugas/my_detail/'.$this->uri->segment(4));?>" class="btn btn-primary btn-xs pull-right"><i class="fa fa-eye"></i> Lihat Detail</a>
                    </div>
                </div>
            </div><!-- /.page-header -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-body">
                                <form action="<?php echo base_url() ?>manager/tugas/my_create_action" method="post" enctype="multipart/form-data">
                                                                          ...
                                                                          <div class="card card-footer">
                                                                            <div class="row">
                                                                                <div class="col-9">
                                                                                  ...
                                                                                  <input type="hidden" id="mUser" name="id_user" value="<?php echo $key_data->id_manager ?>">
                                        ...
                                        <div class="row">
                                          <div class="col-6 col-md-3">
                                            <div class="form-group form-inline">
                                              <input type="radio" class="form-control" name="progress" id="progress" value="25" required>
                                    ...
                                    <div class="form-group">
                                        <div class="progress">
                                            <div class="bar progress-bar bg-primary progress-bar-striped progress-bar-animated" role="progressbar" style="width: 0%" aria-valuenow="88"
                        aria-valuemin="0" aria-valuemax="100"></div>
                                            <div class="percent" style="font-size:8px">0%</div >
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="card-main">
                                        ...
                                        <img src="<?php echo base_url() ?>assets/tugas/upload/<?php echo $data_tugas->file_tugas ?>" width="50"></img> <br> <?php echo $data_tugas->file_tugas ?> >> <a href="<?php echo base_url() ?>assets/tugas/upload/<?php echo $data_tugas->file_tugas ?>" class="btn btn-primary btn-minier" download>Unduh</a>
...
<script>
  $(document).ready(function(){
        $('#btnMessage').click(function(){
              ...
              $.ajax({
                url :'<?php echo base_url();?>manager/tugas/my_reply_message',
                type:'post',
  ...
  {
    $.ajax({
      url:'<?php echo base_url();?>manager/tugas/my_read_message',
      type:'post',
      data:{id:id},
      success:function(response){
        console.log('sukses');
