                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var t = $("#mytable").dataTable({
                                ...
                                processing: true,
                                serverSide: true,
                                ajax: {"url": "<?php echo base_url() ?>marketing/spk_report/json_report/<?php echo $pil_tanggal ?>/<?php echo $tanggal ?>/<?php echo $id_merk ?>", "type": "POST"},
                                columns: [
                                    {
                                        "data": "id",
                                        "orderable": false
                                    },{"data": "tgl_spk"},{"data": "nama"},{"data": "nm_merk"},
                                ],
                                order: [[0, 'desc']],
