                              ...
                              <div class="modal-body">
                                ...
                                <div class="tab-content" id="myTabContent">
                                  <div class="tab-pane fade card card-body" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <form action="<?php echo base_url('marketing/tugas/susulan') ?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                  ...
                                  <div class="tab-pane fade show active card card-body border" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <form action="<?php echo base_url('marketing/tugas/create_action') ?>" method="post">
                                            <div class="form-group mb-2" >
                                                ...
                                                <script>
                                                    ...
                                                    function upload(){
                                                        //alert(id);
                                                        window.location = '<?php echo base_url();?>pegawai/tugas/read/'+id;
                                                    }
                                                </script>
                                            </div>
                                        </form>
