                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="card card-body">
                                <form action="<?php echo base_url() ?>marketing/tugas/create_action" method="post" enctype="multipart/form-data">
...
<script>
  $(document).ready(function(){
    $('#btnMessage').click(function(){
      ...
      $.ajax({
        url :'<?php echo base_url();?>marketing/tugas/reply_message',
        type:'post',
  ...
  {
    $.ajax({
      url:'<?php echo base_url();?>marketing/tugas/read_message',
      type:'post',
      data:{id:id},
      success:function(response){
        console.log('sukses');
