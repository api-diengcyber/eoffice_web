                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tgl_kunjungan" id="datepicker1" placeholder="Tgl Kunjungan" value="<?php echo $tgl_kunjungan; ?>" readonly />
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="alamat_atas_nama" id="alamat_atas_nama" placeholder="Alamat Atas Nama" value="<?php echo $alamat_atas_nama; ?>" readonly />
                    </div>
                    <div class="form-group">
                        <label for="varchar">Keterangan <?php echo form_error('keterangan') ?></label>
                        <textarea class="form-control" name="keterangan" id="keterangan" placeholder="Keterangan" readonly ><?php echo $keterangan; ?></textarea>
                    </div>
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <center>
                        ...
                        <a href="<?php echo site_url('marketing/daily_sales_report') ?>" class="btn btn-default">Cancel</a>
                    </center>
                  </div>
                </div>
                </form>
