                ...
                <div class="col-12">
                    ...
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="<?php echo base_url('admin/tugas/rekap') ?>" class="btn btn-dark">Rekap Tugas</a>
                            <a href="<?php echo base_url('admin/tugas/priority') ?>" class="btn btn-primary"><i class="mdi mdi-list"></i> Ubah Prioritas</a>
                            <?php echo anchor(site_url('admin/tugas/create'), 'Create', 'class="btn btn-primary"'); ?>
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 10px">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var t = $("#mytable").dataTable({
                                ...
                                processing: true,
                                serverSide: true,
                                ajax: {"url": "<?php echo base_url() ?>admin/tugas/json/<?php echo $id_pegawai ?>/<?php echo $bulan ?>/<?php echo $tahun ?>/<?php echo $status ?>", "type": "POST"},
                                columns: [
                                    {
                                        "data": "id",
                                        "orderable": false
                                ...
                                rowCallback: function(row, data, iDisplayIndex) {
                                    ...
                                    /*
                                    $('td:eq(7)', row).html(ket_upload);
                                    var ket_selesai = "";
                                    if (data.selesai == '1') {
                                        ket_selesai = "<span class='badge badge-success'>Selesai</span>";
                                    } else {
                                        ket_selesai = "<span class='badge badge-danger'>Belum Selesai</span>";
                                    }
                                    $('td:eq(8)', row).html(ket_selesai);
                                    */
                                }
                            });
                        });
