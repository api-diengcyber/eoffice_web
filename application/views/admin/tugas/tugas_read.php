                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="space"></div>
                            <?php if ($selesai=='1') { ?>
                            <a onclick="return cBatal()" href="<?php echo base_url() ?>admin/tugas/selesai/<?php echo $id ?>/0" class="btn btn-danger btn-rounded"><i class="ace-icon fa fa-times"></i> Batal Selesai</a>
                            <?php } else { if($progress == 100) { ?>
                            <a onclick="return cSelesai()" href="<?php echo base_url() ?>admin/tugas/selesai/<?php echo $id ?>" class="btn btn-primary btn-rounded"><i class="ace-icon fa fa-check"></i> Konfirmasi Selesai</a>
                            <?php } } ?>
                        </div>
                    </div>
                    <br>
                    <a href="<?php echo site_url('admin/tugas') ?>" class="btn btn-danger btn-rounded">Kembali</a>
                    <!-- PAGE CONTENT ENDS -->
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.page-content -->
