                            ...
                            <table border="1" style="width:100%;">
                                <thead>
                                    <tr style="font-weight: bold;background-color: green;color:white">
                                        <td width="30" align="center">TGL</td>
                                        <td width="100" align="center">HARI</td>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        <tr style="<?php echo $tr_style ?>">
                                            <td align="center" style="vertical-align:middle;"><?php echo date('d', $str_date) ?></td>
                                            <td align="center" style="vertical-align:middle;"><?php echo $dayList[$day] ?></td>
                                            <td style="vertical-align:middle;"><?php echo $ip ?></td>
                                            ...
                                            <td align="center" style="vertical-align:middle;"><?php echo $jam_pulang ?></td>
                                            <td align="center" style="vertical-align:middle;">
                                                <?php
                                                        $color = "";
                                                        if ($l->id_jabatan == "4") {
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <tr>
                                        <th align="right" colspan="9">TOTAL HARI</th>
                                        <th><?php echo $total_hari ?></th>
                                    </tr>
                                    <tr>
                                        <th align="right" colspan="9">JUMLAH MASUK</th>
                                        <th><?php echo $jml_masuk ?></th>
                                    </tr>
                                    <tr>
                                        <th align="right" colspan="9">JUMLAH HARI MINGGU / LIBUR </th>
