<link rel="stylesheet" href="<?php echo base_url('assets/magn/magnific-popup.css') ?>">#897b14
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped capitalize" id="myTable">
                                <thead class="table-dark" style="border:solid 1px #212529">
                                    ...
                                    <tr>
                                        <th style="text-align:center;border: 1px solid #212529" colspan="2">Laporan</th>
                                    </tr>
                                    <tr>
                                        <th style="text-align:center;background-color:#CDDC39" width="50%">Pagi</th>
                                        <th style="text-align:center;background-color:#8BC34A;" width="50%">Siang</th>
                                    </tr>
                                </thead>
                                <tbody>
                                                ...
                                                <ul class="mlist">
                                                    <?php if (!empty($l->laporan_pagi[0]->tgl)) { ?>
                                                        <?php foreach ($l->laporan_pagi as $lp) : ?>
                                                            <li>
                                                                <span><?php echo $lp->judul; ?></span> <br>
                                                                <span><?php echo $lp->tugas; ?></span> <br>
                                                                <span>Keterangan : </span> <br>
                                                                <?php echo ($lp->ket) ? $lp->ket : 'Tidak ada keterangan'; ?> <br>
                                                                <a href="<?php echo base_url('assets/tugas/upload/') . $lp->file ?>" class="badge badge-success img"><i class="fa fa-eye"></i> Lihat Lampiran</a>
                                                                <a href="<?php echo base_url('admin/tugas/read/') . $lp->id_tugas ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat Detail</a>
                                                            </li>
                                                        <?php endforeach ?>
                                                    <?php } else { ?>
                                                        Belum upload tugas
                                                    ...
                                                    <?php if (!empty($l->laporan_siang[0]->tgl)) { ?>
                                                        <?php foreach ($l->laporan_siang as $ls) : ?>
                                                            <li>
                                                                ...
                                                                <a href="<?php echo base_url('assets/tugas/upload/') . $ls->file ?>" class="badge badge-success img"><i class="fa fa-eye"></i> Lihat Lampiran</a>
                                                                <a href="<?php echo base_url('admin/tugas/read/') . $ls->id_tugas ?>" class="badge badge-primary"><i class="fa fa-eye"></i> Lihat Detail</a>
                                                            </li>
                                                        <?php endforeach ?>
                                                    <?php } else { ?>
                                                        Belum upload tugas
