...
class Pil_level extends CI_Controller
{
    ...
    public $active = array('active_utilities' => 'active_pil_level');
    ...
    public function create() 
    {
        ...
        $data = array(
            ...
            'level_number' => '',
            // 'all_level' => $this->Pil_level_model->get_all(),
    	);
        // var_dump($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'level_number' => set_value('level', $row->level_number),
                // 'level' => $this->Pil_level_model->get_all(),
        	    );
            $this->Tampilan_model->layar('pil_level/pil_level_form', $data, $this->active);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
