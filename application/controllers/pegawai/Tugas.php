...
class Tugas extends CI_Controller {
	...
	public $active = array('active_tugas' => 'harian');
    ...
    public function index()
    {
     ...
     public function laporan_harian(){
        ...
        $this->Tampilan_model->layar('tugas/laporan_harian',$data,$this->active = array('active_tugas' => 'kegiatan'));
    }
    public function detail($id_tugas)
    {
        ...
        $this->Tampilan_model->layar('tugas/detail',$data,$this->active);
    }
	public function read($id)
	{
		...
		if ($row) {
			...
			redirect(site_url('pegawai/tugas'));
		}
	}
	...
	public function create_action()
	{
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('pegawai/tugas/read/'.$this->input->post('id', TRUE).''));
        }
	}
    ...
    public function reply_message()
    {
        ...
        redirect(site_url('pegawai/tugas/read/'.$id),'refresh');
    }
    public function susulan()
    {
        ...
        redirect(site_url('pegawai/tugas'),'refresh');
    }
