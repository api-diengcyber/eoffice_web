...
class Tugas extends CI_Controller {
    ...
    public $active = array('active_tugas' => 'active');
    ...
    public function laporan_harian(){
        ...
        $this->Tampilan_model->layar('tugas/laporan_harian',$data);
    }
    public function read($id)
    {
        ...
        if ($row) {
            ...
            redirect(site_url('marketing/tugas'));
        }
    }
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('marketing/tugas/read/'.$this->input->post('id', TRUE).''));
        }
    }
    ...
    public function reply_message()
    {
        ...
        redirect(site_url('marketing/tugas/read/'.$id),'refresh');
    }
    public function susulan()
    {
        ...
        redirect(site_url('marketing/tugas'),'refresh');
    }
