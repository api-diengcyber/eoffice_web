...
class Daily_sales_report extends CI_Controller
{
    ...
    public $active = array('active_daily_sales_report' => 'active');
    ...
    public function create() 
    {
        ...
        $data = array(
            'button' => 'Simpan',
            'action' => site_url('marketing/daily_sales_report/create_action'),
            'id' => set_value('id'),
            'tgl' => set_value('tgl'),
    ...
    public function follow_up($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Follow Up',
                'action' => site_url('marketing/daily_sales_report/follow_up_action'),
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('marketing/daily_sales_report/update_action'),
                'id' => set_value('id', $row->id),
