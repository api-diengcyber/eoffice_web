...
class Tidak_masuk extends CI_Controller
{
    ...
    public function read($id)
    {
        ...
        if ($row) {
            ...
            redirect(site_url('marketing/tidak_masuk'));
        }
    }
    ...
    public function create()
    {
        ...
        $data = array(
            'button' => 'Create',
            'action' => site_url('marketing/tidak_masuk/create_action'),
            'id' => set_value('id'),
    ...
    public function create_action()
    {
        ...
        if ($row_absen) {
            ...
            redirect(site_url('training/tidak_masuk'));
        } else {
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('marketing/tidak_masuk/update_action'),
