...
class Auth extends CI_Controller
{
		...
		if ($this->form_validation->run() == true) {
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember)) {
				...
				if ($row_pegawai) {
					...
					$array = array(
						'users_id_office' => $row_pegawai->id_users,
						'users_id_pegawai_office' => $row_pegawai->id,
						'users_username_office' => $this->input->post('identity', TRUE),
						'users_level_office' => $row_pegawai->level,
					);
	...
	public function register()
	{
		...
		if ($this->form_validation->run() == true) {
			...
			$r = $this->ion_auth->register($identity, $password, $identity, $additional_data);
			if ($r) {
				...
				$this->session->set_flashdata('message', !empty($this->ion_auth->errors()) ? $this->ion_auth->errors() : 'Daftar kendala!');
